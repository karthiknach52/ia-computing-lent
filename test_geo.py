...
def test_check_stations_are_within_radius():
    ...
    stations = [MonitoringStation("s_id", "m_id", "label", (0, i * 0.01), (-2.3, 3.4445), "river", "town")
                for i in range(1, 11)]
...
def test_check_no_stations_in_radius_empty_input():
...
def test_rivers_by_station_number_most_stations():
    ...
    stations = [MonitoringStation("s_id", "m_id", "label", (0, 0), (-2.3, 3.4445), "river" + str(i), "town")
...
def test_rivers_by_station_number_correct_length():
    ...
    stations = [MonitoringStation("s_id", "m_id", "label", (0, 0), (-2.3, 3.4445), "river" + str(i % 5), "town")
                for i in range(1, 11)]
